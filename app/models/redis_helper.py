        ...
        try:
            ...
            try:
                prompt_human_help = f"""
                    ...
                    Проанализируй запрос. Верни `True`, если нужен реальный человек для ответа, и `False`, если ИИ может ответить самостоятельно, используя доступные данные или RAG. Ответ должен быть в формате JSON, например:
