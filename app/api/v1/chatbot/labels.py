...
OUTSIDE_WORKING_HOURS_RESPONSE = """Служба заботы о клиентах принимают запросы 24/7, но
обрабатываются с 9:00 - 19:00, в порядке очереди.
Если Вы написали после 19:00, они будут обрабатываться
